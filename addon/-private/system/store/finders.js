...
function getInverse(store, { modelName }, { name: lhs_relationshipName }, type) {
  if (store.modelDataWrapper) {
    return recordDataFindInverseRelationshipInfo(store, modelName, lhs_relationshipName, type);
  } else {
    return legacyFindInverseRelationshipInfo(store, modelName, lhs_relationshipName);
  }
}
...
function legacyFindInverseRelationshipInfo(store, modelName, lhs_relationshipName) {
